...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Light = __webpack_require__(167);

	var FabriconsLight = _interopRequireWildcard(_Light);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: 'glyph' },
	          Object.keys(FabriconsLight).map(this.renderIcon)
	        )
	      );
	    }
	  }]);
				...
				var IconLightCheck = function (_Component) {
					...
					_createClass(IconLightCheck, [{
						...
						value: function render() {
							return _react2.default.createElement(_BaseIcon2.default, _extends({}, this.props, {
								name: 'IconLightCheck',
								viewBox: '0 0 1920 1920' }), _react2.default.createElement('g', { 'fill-rule': 'evenodd' }, _react2.default.createElement('path', { d: 'M1640.95 346.964c37.487-37.487 98.27-37.482 135.758.006 37.49 37.49 37.496 98.269.006 135.758L687.05 1572.392c-37.487 37.487-98.27 37.482-135.758-.006-37.49-37.49-37.496-98.27-.006-135.759L1640.95 346.964z' }), _react2.default.createElement('path', { d: 'M143.287 1029.971c37.49-37.49 98.268-37.497 135.769.004l407.286 407.286c37.492 37.492 37.491 98.28.003 135.768-37.49 37.49-98.267 37.497-135.768-.004L143.291 1165.74c-37.492-37.492-37.492-98.28-.004-135.768z' })));
						}
					}]);
